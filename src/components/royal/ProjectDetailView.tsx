            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              {project.links.website && (
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-background/80 px-4 py-2 text-xs font-semibold text-foreground backdrop-blur transition-all duration-300 hover:border-electric hover:bg-electric hover:text-white hover:shadow-md"
                >
              ...
              {project.links.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-background/80 px-4 py-2 text-xs font-semibold text-foreground backdrop-blur transition-all duration-300 hover:border-pink-500 hover:bg-pink-600 hover:text-white hover:shadow-md"
                >
              ...
              {project.links.facebook && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-background/80 px-4 py-2 text-xs font-semibold text-foreground backdrop-blur transition-all duration-300 hover:border-blue-500 hover:bg-blue-600 hover:text-white hover:shadow-md"
                >
